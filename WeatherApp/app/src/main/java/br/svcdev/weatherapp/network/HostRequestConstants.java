...
public abstract class HostRequestConstants {
    ...
    public static final String CONTROLLER_DAILY_FORECAST = "/data/2.5/forecast/daily?";
    public static final String CONTROLLER_FIVE_DAYS_PER_THREE_HOURS_FORECAST = "/data/2.5/forecast?";
